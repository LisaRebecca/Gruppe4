...
public class Automat extends JFrame {
	 ...
	 */
	private JLabel jlbl_desc, jlbl_sum;
	 ...
	 */
	private ArrayList<Produktauswahl> list_productSelection = new ArrayList<Produktauswahl>();
	 ...
	 */
	private JTable jt_obtainableProducts = DatabaseConnector.executeDBQuery(cus_sql);
	...
	public Automat() {
		...
		/** Das Gesamtsummenlabel, bekommt den entsprechenden String zugewiesen und wird dem BarPanel hinzugefügt.
		 */
		jlbl_sum = new JLabel("Gesamtpreis: ____€");
		jp_barPanel.add(jlbl_sum);

		/** Der Kaufen-Button bekommt einen entsprechenden String zugewiesen und seine Farbe wird auf weiß gesetzt.
		 */
