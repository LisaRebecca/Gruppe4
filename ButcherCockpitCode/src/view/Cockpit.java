...
public class Cockpit extends JFrame {
	...
	public Cockpit() {
		...
		/**
		 * den Tabs werden geweils wei�e JPanels hinzugef�gt
		 */
		...
		/**
		 * Lagerbestandtabelle und Label werden dem JPanel hinzugefügt.
		 */
		...
		/**
		 * Produkttabelle und Label werden dem JPanel hinzugefügt.
		 */
		...
		/**
		 * Automatenbestandstabelle und Label werden dem JPanel hinzugefügt.
		 */
		...
		/**
		 * Verkaufstabelle und Label werden dem JPanel hinzugefügt.
		 */
